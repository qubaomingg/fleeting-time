    ...
    $.fn.extend({
        sSelect: function(fixTop) {
            return this.each(function(i,obj){
                ...
                if(obj.style.display != 'none' && $(this).parents()[0].id.indexOf('__jQSelect')<0){
                    ...
                    $('#'+selectId).append('<div class="dropselectbox"><h4></h4><div class="scroller" style="display:none;"><div class="scrollbar"><div class="track"><div class="thumb"><div class="end"></div></div></div></div><div class="viewport"><ul class="overview" style="display:none;"></ul></div></div></div>');
                    ...
                    $('#'+selectId)
                        ...
                        .bind("click",function(e){
                            if($('#'+selectId+' ul').css("display") == 'block'){
                                ...
                                $('#'+selectId+' select').trigger('beforeopen');
                                ...
                                // });
                                $('#'+selectId+' li').on("click",function(e){
                                ...
                                $('#'+selectId+' select').trigger('afteropen');
                            };
                            e.stopPropagation();
                        })
        ...
        clearSelectMenu:function(selectId,selectZindex){
            if(selectId != undefined){
                ...
                $('#'+selectId+' select').trigger('afterclose');
                $('#'+selectId).parent().css({
                    'z-index':"0"
                });
                $('#'+selectId).css({
